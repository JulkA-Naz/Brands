(() => {
    ...
    function initSliders() {
        if (document.querySelector(".image-slider-1")) new core(".image-slider-1", {
        ...
        if (document.querySelector(".image-slider-2")) new core(".image-slider-2", {
            modules: [ Navigation, Autoplay, EffectFade ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".image-slider-3")) new core(".image-slider-3", {
            modules: [ Navigation, Autoplay, EffectFade ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".image-slider-4")) new core(".image-slider-4", {
            modules: [ Navigation, Autoplay, EffectFade ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".image-slider-5")) new core(".image-slider-5", {
            modules: [ Navigation, Autoplay, EffectFade ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
